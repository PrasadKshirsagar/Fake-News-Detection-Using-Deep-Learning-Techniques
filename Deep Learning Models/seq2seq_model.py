...
history = seq2seq_Model.fit(X_train, y_train, batch_size=batch_size, epochs=3, validation_split=0.1, verbose = 1)
...
dataset2 = pd.read_csv('../input/btp-dataset/liar_test.csv')
X_test_init = dataset2.iloc[:, 2:3].values
